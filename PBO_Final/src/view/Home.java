...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/controller/DESAIN PENATAAN RUANG TOKO BANGUNAN YANG MENARIK4.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel2.setText("Sistem Inventaris Toko Bangunan");

        Lanjut.setBackground(new java.awt.Color(255, 255, 51));
    ...
    private void LanjutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LanjutActionPerformed
        ...
        barangView barangView1 = new barangView();
        barangView1.setVisible(true);
        dispose();
